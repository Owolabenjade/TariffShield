...
export const Env = z.object({
  ...
  REDIS_URL: z.string().default("redis://localhost:6379").describe("Redis connection string, shared by the BullMQ job queue and the on-chain account state cache (#246)"),
