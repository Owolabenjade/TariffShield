...
export const Env = z.object({
  ...
  PG_POOL_MAX: z.coerce.number().int().positive().default(20).describe("Max concurrent PostgreSQL connections per API instance (issue #264, #241)"),
  ...
  PG_STATEMENT_TIMEOUT_MS: z.coerce.number().int().positive().default(10000).describe("Milliseconds before a single PostgreSQL statement is cancelled (issue #241)"),
